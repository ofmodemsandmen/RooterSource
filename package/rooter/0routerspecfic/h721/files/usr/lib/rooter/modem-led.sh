...
if [ $DEVV = "1" ]; then
	case $COMMD in
		"0" )
			echo none > /sys/class/leds/h721:green:4g5g/trigger
			echo 0  > /sys/class/leds/h721:green:4g5g/brightness
			echo none > /sys/class/leds/h721:green:rssi_lte1/trigger
			echo 0  > /sys/class/leds/h721:green:rssi_lte1/brightness
			;;
		"1" )
		...
		"4" )
			echo none > /sys/class/leds/h721:green:4g5g/trigger
			echo 1  > /sys/class/leds/h721:green:4g5g/brightness
			sig2=$3
	...
	case $COMMD in
		"0" )
			echo none > /sys/class/leds/h721:green:4g/trigger
			echo 0  > /sys/class/leds/h721:green:4g/brightness
			echo none > /sys/class/leds/h721:green:rssi_lte2/trigger
			echo 0  > /sys/class/leds/h721:green:rssi_lte2/brightness
			;;
		"1" )
		...
		"4" )
			echo none > /sys/class/leds/h721:green:4g/trigger
			echo 1  > /sys/class/leds/h721:green:4g/brightness
			sig=$3
