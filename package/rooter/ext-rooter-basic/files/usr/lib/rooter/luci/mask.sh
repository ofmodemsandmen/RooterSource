		...
		case $uPid in
			...
			"0900" )
				...
				if [ -z "$f2" ]; then
					...
					M2='1110101100000000000100000001000000000101100000000000000000000000010'
					M5='1111101100000000000100000001000000000101100000000000000000000000010000000000110'
					M6=""
				fi
				CA=""
				CA3=""
