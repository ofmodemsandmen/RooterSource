		...
		case $uPid in
			...
			"0800"|"0900" ) # RM500
				...
				if [ ! -z "$f2" ]; then
					...
					M5='1110101100010000000100001001000000000101100000010000000000000000000000100001000001110'
					M6='1110101100010000000100001001000000000101100000010000000000000000000000100001000001110'
				else
