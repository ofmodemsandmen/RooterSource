...
case $uVid in
		...
		case $uPid in
			...
			"0800") # RM500
				...
				if [ -z "$f2" ]; then #RM502/505/510
					...
					M5='1110101100010100100100001001000000000101100000010000000000000000010000100000111'
					M6=$M5
				else
					GL=$(echo $model | grep "GL")
	...
	;;
	"0e8d" )
		M2='111110110001110011110000110111010100011111100101000000000000000001000010'
		M5='11101011000000000001000010010100000001011000000100000000000000000100000000001110'
		CA=""
		CA3=""
	;;
	"413c" )
