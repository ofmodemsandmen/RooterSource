...
case $uVid in
		...
		case $uPid in
			...
			"0900" )
				...
				if [ -z "$f2" ]; then
					...
					M6='1011001100000000000100000001000000000101100000000000000000000000010000000000110'
					M5=""
				fi
				CA=""
				CA3=""
	...
	"413c" )
		case $uPid in
			...
			"81df")
				M2='1111101100011100111100001101110101000111110001010000000000000000010000100'
				M5=''
				CA=""
				CA3=""
			;;
		esac
