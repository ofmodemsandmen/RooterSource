...
PXELL_LTE="RAT:LTEMCC:.\+PCELL:LTE_BAND:[0-9]\+[^C]\+LTE_BAND_WIDTH:[.0-9]\{1,6\}MHZCHANNEL:[0-9]\+PCI:[0-9]\{1,3\}RSRP:.\{2,8\}DBM,RSRQ:.\{2,8\}DB.\{12,20\},SNR:.\{3,7\}DB"
PXELL_LTE1="RAT:LTEMCC:.\+PCELL:LTE_BAND:[0-9]\+[^C]\+LTE_BAND_WIDTH:[.0-9]\{1,6\}MHZCHANNEL:[0-9]\+PCI:[0-9]\{1,3\}LTE_RSRP:.\{2,8\}DBM,RSRQ:.\{2,8\}DB.\{12,20\},LTE_SNR:.\{3,7\}DB"
PXRELL_LTE="RAT:LTE+NRMCC:.\+PCELL:LTE_BAND:[0-9]\+[^C]\+LTE_BAND_WIDTH:[.0-9]\{1,6\}MHZCHANNEL:[0-9]\+PCI:[0-9]\{1,3\}RSRP:.\{2,8\}DBM,RSRQ:.\{2,8\}DB.\{12,20\},SNR:.\{3,7\}DB"
PXRELL_LTE1="RAT:LTE+NRMCC:.\+PCELL:LTE_BAND:[0-9]\+[^C]\+LTE_BAND_WIDTH:[.0-9]\{1,6\}MHZCHANNEL:[0-9]\+PCI:[0-9]\{1,3\}LTE_RSRP:.\{2,8\}DBM,RSRQ:.\{2,8\}DB.\{12,20\},LTE_SNR:.\{3,7\}DB"
